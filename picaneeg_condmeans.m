function p=picaneeg_condmeans(p,winstart,winend)
% usage p=picaneeg_condmeans(p,winstart,winend)
% gets some condition- and trial-related average 
% given p generated from picaneeg_loadraw and picaneeg_segmenttrials
% where winstart and winend are in ms
% giving all of mean, max, min, meanpersec in a montage

if nargin<3, winend = size(p.EEGTrialData,3); end
if nargin<2, winstart = 1; end
