function p=picaneeg_loadraw(fname,freqlb,frequb,enet,makesmall,absorrel,graphics,dorescaleoutliers)
% usage:p=picaneeg_loadraw(fname,freqlb,frequb,enet,makesmall,absorrel)
...
if nargin<8, 
  ...
  elseif strcmp (enet,'besa_dat'), dorescaleoutliers=0; %processed dat files don't need rescale outliers? added by Josh 7/28
  else
    dorescaleoutliers=1; 
  end
end
