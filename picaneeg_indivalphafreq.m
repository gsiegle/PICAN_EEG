function p=picaneeg_indivalphafreq(fname, enet, channels, dorescaleoutliers)
...
% only need a little bit of the file to estimate alpha
if size(p.EEG,1)>40000, p.EEG=p.EEG(10000:40000,:); end
