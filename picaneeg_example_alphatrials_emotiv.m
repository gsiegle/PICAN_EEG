function p=picaneeg_example_alphatrials_emotiv(lb,ub,graphics,fname)
...
p=picaneeg_condmeans(p,200,400); % gets the trial and condition related averages between 200 and 400ms
